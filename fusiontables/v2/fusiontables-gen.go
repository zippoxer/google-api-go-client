...
// Usage example:
//
//   import "github.com/zippoxer/google-api-go-client/fusiontables/v2"
//   ...
//   fusiontablesService, err := fusiontables.New(oauthHttpClient)
package fusiontables // import "github.com/zippoxer/google-api-go-client/fusiontables/v2"
...
// string assigned to a user, but should not exceed 40 characters.
// Overrides userIp if both are provided.
func (c *TableReplaceRowsCall) QuotaUser(quotaUser string) *TableReplaceRowsCall {
	c.urlParams_.Set("quotaUser", quotaUser)
	return c
}
...
// where the request originates. Use this if you want to enforce
// per-user limits.
func (c *TableReplaceRowsCall) UserIP(userIP string) *TableReplaceRowsCall {
	c.urlParams_.Set("userIp", userIP)
	return c
}

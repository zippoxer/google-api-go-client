...
// Usage example:
//
//   import "github.com/zippoxer/google-api-go-client/dfareporting/v1.3"
//   ...
//   dfareportingService, err := dfareporting.New(oauthHttpClient)
package dfareporting // import "github.com/zippoxer/google-api-go-client/dfareporting/v1.3"
...
// string assigned to a user, but should not exceed 40 characters.
// Overrides userIp if both are provided.
func (c *ReportsCompatibleFieldsQueryCall) QuotaUser(quotaUser string) *ReportsCompatibleFieldsQueryCall {
	c.urlParams_.Set("quotaUser", quotaUser)
	return c
}
...
// where the request originates. Use this if you want to enforce
// per-user limits.
func (c *ReportsCompatibleFieldsQueryCall) UserIP(userIP string) *ReportsCompatibleFieldsQueryCall {
	c.urlParams_.Set("userIp", userIP)
	return c
}
